...
For an "ugly hack version" - Check out [examples/three-azure-v1.html](https://github.com/ProjectPete/amazon-sumerian-hosts/blob/mainline/examples/three-azure-v1.html) in the examples folder and [examples/azure-duck-punch.js](https://github.com/ProjectPete/amazon-sumerian-hosts/blob/mainline/examples/azure-duck-punch.js) for some old skool duck-punching and event burglerising, to replace Polly and AWS TTS service. It's ugly, but it works, only took an hour to crack and encouraged me to return, and do it properly in version 2, below.
